...
class EnergyFormatter(GenericDataFormatter):
  ...
  _column_definition = [
      ...
      #('Prev_week', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ...
      ('Prev_week', DataTypes.REAL_VALUED, InputTypes.STATIC_INPUT),
  ]
  ...
  def split_data(self, df):
    ...
    valid = df[int(0.65*len(df)):int(0.8*len(df))]
