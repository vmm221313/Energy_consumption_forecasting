...
import data_formatters.energy_consumption
...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita', 'energy_consumption']
  ...
  def hyperparam_iterations(self):
    ...
    my_search_iterations=100
    
    if self.experiment == 'energy_consumption':
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'energy_consumption': data_formatters.energy_consumption.EnergyFormatter
    }
